...
const Button = ({ type, onClick, variant, children }: IButtonProps) => {
  return (
    <button
      ...
      className={
        variant === 'bordered'
          ? 'flex justify-center items-center h-10 py-3 px-6 text-sm font-medium rounded-xl w-full transition duration-100 ease-in-out cursor-pointer whitespace-nowrap border border-main-purple bg-white text-main-purple hover:text-white hover:bg-main-purple'
          : variant === 'google'
